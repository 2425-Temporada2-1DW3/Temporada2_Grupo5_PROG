...
import java.awt.*;
public class GestionTemporadav2 {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(() -> {
			try {
				GestionTemporadav2 window = new GestionTemporadav2();
...
//		frame.getContentPane().add(scrollPane);
        ...
        // Opcional: Establecer un renderizador para mostrar los valores booleanos de manera legible (Iniciado/Finalizado)
